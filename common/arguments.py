...
def get_args():
    ...
    parser.add_argument("--buffer_size", type=int, default=int(10000), help="number of transitions can be stored in buffer")
    ...
    parser.add_argument("--max_episodes", type=int, default=10000, help="number of training episodes, only for policy-based methods")        # original: 2000
